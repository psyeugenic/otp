...
bif_to_test('=:<', [A,B], Fail) -> {test,is_ge_exact,Fail,[B,A]};
bif_to_test('>:>', [A,B], Fail) -> {test,is_lt_exact,Fail,[B,A]};
bif_to_test('<:<', [_,_]=Ops, Fail) -> {test,is_lt_exact,Fail,Ops};
bif_to_test('>:=', [_,_]=Ops, Fail) -> {test,is_ge_exact,Fail,Ops};
bif_to_test('=:=', [A,[]], Fail) -> {test,is_nil,Fail,[A]};
...
is_pure_test({test,is_ge_exact,_,[_,_]}) -> true;
is_pure_test({test,is_lt_exact,_,[_,_]}) -> true;
